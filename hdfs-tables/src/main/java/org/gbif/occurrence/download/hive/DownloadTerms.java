...
public class DownloadTerms {
  ...
  public static final Set<Term> EXCLUSIONS_HDFS =
      Stream.concat(
              EXCLUSIONS_INTERPRETED.stream(),
              Stream.of(GbifTerm.verbatimScientificName)).collect(Collectors.toSet());
   ...
   */
  public static final List<Term> DOWNLOAD_MULTIMEDIA_TERMS =
  ...
  private static final List<Pair<Group, Term>> ADDITIONAL_SIMPLE_WITH_VERBATIM_DOWNLOAD_TERMS =
      List.of(
  ...
  public static final List<Pair<Group, Term>> SIMPLE_WITH_VERBATIM_DOWNLOAD_TERMS =
  ...
  public static final List<Pair<Group, Term>> SPECIES_LIST_TERMS =
          List.of(
          Pair.of(Group.INTERPRETED, GbifTerm.gbifID),
          Pair.of(Group.INTERPRETED, GbifTerm.datasetKey),
          Pair.of(Group.INTERPRETED, DwcTerm.occurrenceID),
  ...
  public static final List<Pair<Group, Term>> SPECIES_LIST_DOWNLOAD_TERMS =
          List.of(
          Pair.of(Group.INTERPRETED, GbifTerm.taxonKey),
          Pair.of(Group.INTERPRETED, DwcTerm.scientificName),
          Pair.of(Group.INTERPRETED, GbifTerm.acceptedTaxonKey),
  ...
  public static final List<Term> INTERNAL_DOWNLOAD_TERMS =
          List.of(GbifInternalTerm.publishingOrgKey, IucnTerm.iucnRedListCategory);

  /** GBIF-Internal terms available for public searches (SQL downloads) */
  public static final List<Term> INTERNAL_SEARCH_TERMS =
          List.of(
